export default function Home() {
  return (
    <div className="lg:px-4 px-[10%] text-black space-y-5 top-0 ">
      <div className="lg:flex lg:flex-row lg:w-full text-[30px] lg:text-[40px] font-semibold lg:flex-wrap gap-10">
        Welcome to the Library API Demo App!
      </div>
      <div className="lg:flex lg:flex-row lg:w-full text-[20px] lg:text-[16px]lg:flex-wrap">
      ...
      <div className="lg:flex lg:flex-row lg:w-full text-[18px] lg:text-[16px] lg:flex-wrap">
